...
public final class NetworkHandler {
    ...
    public static void register() {
        ...
        CHANNEL.registerMessage(id++, ExecuteTechniqueSlotC2S.class, ExecuteTechniqueSlotC2S::encode, ExecuteTechniqueSlotC2S::decode, ExecuteTechniqueSlotC2S::handle, Optional.of(NetworkDirection.PLAY_TO_SERVER));
        ...
        CHANNEL.registerMessage(id++, OpenNpcQuestScreenS2C.class, OpenNpcQuestScreenS2C::encode, OpenNpcQuestScreenS2C::decode, OpenNpcQuestScreenS2C::handle, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
    }
